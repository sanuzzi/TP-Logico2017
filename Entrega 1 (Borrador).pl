...
%///
alquilerRequerido(carlos , (alquiler(UnaCasa, _))):-
 alquiler(UnaCasa,_),
...
%--------------
alquilerRequerido(ana,(alquiler(UnaCasa, _))):-
alquiler(UnaCasa, _),
...
%>> False
%--------------
alquilerRequerido(maria,(alquiler(UnaCasa, _))):-
alquiler(UnaCasa, _),
ambientes(UnaCasa,UnosAmbientes),
piscina(UnaCasa,Metros),
UnosAmbientes >=2,
...
alquilerRequerido(chamaleon,Lugar):- alquilerRequerido(maria,Lugar).
